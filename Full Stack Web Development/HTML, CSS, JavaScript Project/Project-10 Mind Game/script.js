...
const win = () => {
    ...
    const allFlipped = [...boxes].every((box) => box.classList.contains("flip"));
    if (allFlipped) {
        showWinScreen();
    }
  }
...
// For Game Over if you not Completed the game in given time .
...
var duration = 60 * 4; // 4 minutes in seconds
